...
namespace Magus
{
    ...
    { /// <summary>
        ...
        /// </summary>
        public void CalculateModelMatrix(int Width, int Height, float X,float Y)
        {
            Vector3 translation = new Vector3();

            translation = new Vector3(Position.X - Width / 2 - X, Position.Y - Height / 2 - Y, 0.0f);
        ...
        {
            TextureID = textureID;
            Size = new OpenTK.SizeF(width, height);
        }
        ...
        /// </summary>
        public bool IsVisible(int Width, int Height, float X, float Y)
        {
                return Position.X + LongestSide > X && 
                        Position.X - LongestSide < X + Width && 
                        Position.Y + LongestSide > Y && 
                        Position.Y - LongestSide < Y + Height;
